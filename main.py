...
GEMINI_FUNCTIONS = [
    ...
    {"name": "presale_list",
     "description": "Список лидов из пресейл-воронки. Можно отфильтровать по статусу. "
                    "Статусы: «Не квал», «В работе», «Назначена встреча», «Формируем предложение», «Выставлено КП», «Пишем позже». "
    ...
    {"name": "presale_set_status",
     "description": "Сменить статус лида. Статусы: «Не квал», «В работе», «Назначена встреча», «Формируем предложение», «Выставлено КП», «Пишем позже», "
...
Статусы воронки: «Не квал», «В работе», «Назначена встреча», «Формируем предложение», «Выставлено КП», «Пишем позже»; продажа — «Продано».
