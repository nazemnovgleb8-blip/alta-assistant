...
GEMINI_FUNCTIONS = [
    ...
    {"name": "presale_list",
     "description": "Список лидов из пресейл-воронки. Можно отфильтровать по статусу. "
                    "Статусы: «Не квал», «Неразобранные», «В работе», «Назначена встреча», «Формируем предложение», «Выставлено КП», «Пишем позже». "
    ...
    {"name": "presale_set_status",
     "description": "Сменить статус лида. Статусы: «Не квал», «Неразобранные», «В работе», «Назначена встреча», «Формируем предложение», «Выставлено КП», «Пишем позже», "
...
Статусы воронки: «Не квал», «Неразобранные», «В работе», «Назначена встреча», «Формируем предложение», «Выставлено КП», «Пишем позже»; продажа — «Продано».
...
• stage = статус, если назван/ясен из смысла; иначе оставь пустым (будет «Неразобранные»).
...
Правила:
• Новый лид («/лид», «новый лид») → сначала presale_find по имени/бренду (проверь дубль), затем presale_create со ВСЕМИ корректно разложенными полями по схеме выше. Если статус неясен — оставь пустым (будет «Неразобранные»).
